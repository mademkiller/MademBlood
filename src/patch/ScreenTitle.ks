...
[position layer=message0 page=fore frame="" left=0 top=0 width=960 height=720 marginl=0 margint=0 marginr=0 marginb=0 visible=false]
...
[position layer=message0 page=back frame="" left=0 top=0 width=960 height=720 marginl=0 margint=0 marginr=0 marginb=0 visible=false]
...
@eval exp="tf.rand = intrandom(1,5)"
@if exp="tf.rand==1"
...
[iscript]
	...
	core2.screen.kag.onShow= function( time_ ){
		...
		backGround.drawText2( 25, 695, text_, 0xf0d2a0, 214,
