;@title name="VenusBlood-FRONTIER- ver.1.1.3"
...
;ロゴ
@image layer=0 page=back storage="logo_dualtail" left=0 top=0 visible=true oapcity=255
...
@image layer=0 page=back storage="bgffffff" left=0 top=0 visible=true oapcity=255
